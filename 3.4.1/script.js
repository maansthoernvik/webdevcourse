$(document).ready(function() {
  ...
  function animateDivs() {
    ...
    }, 750, 'linear', function() { // I början så visas animationen över 750ms
      $('.divTwo').animate({
        backgroundColor: 'black'
      }, 600, 'linear', function() { // Sedan 600ms
        $('.divThree').animate({
          backgroundColor: 'black'
        }, 450, 'linear', function() { // 450ms
          $('.divFour').animate({
            backgroundColor: 'black'
          }, 300, 'linear', function() { // 300ms
            $('.divFive').animate({
              backgroundColor: 'black'
            }, 150, 'linear'); // end animate, till slut en snabb animation på 300ms
          }); // end animate
        }); // end animate
      }); // end animate
    }); // end animate
